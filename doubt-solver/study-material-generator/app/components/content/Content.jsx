...
export default function Content() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-60px)] relative ">
      ...
      <div className="flex-grow w-full mx-auto p-4 overflow-y-auto  custom-scrollbar">
      ...
      <div className="p-1 mx-auto flex items-center bg-primary  w-full">
        <div className="px-2 py-1  flex items-center w-full">
          <input
            ...
            className="flex-grow  py-2 border text-white rounded-l-md  bg-green-500 placeholder-gray-200 placeholder:text-primary outline-none focus:border-white"
          />
          <button
      ...
      <div className="hidden lg:block fixed bottom-20 right-16">
