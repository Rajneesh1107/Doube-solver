...
const FilterComponent = () => {
  ...
  return (
    <div className="md:hidden flex justify-around items-center mt-1">
      <div>
        <select
          name="complexity"
          onChange={handleSelect}
          className=" focus:ring-1 bg-primary focus:ring-white mb-2 px-4 py-3 rounded-none shadow-sm text-base text-white w-33 cursor-pointer"
        >
      ...
      <div>
        <select
          name="types"
          onChange={handleSelect}
          className="focus:ring-1 focus:ring-white mb-2 px-4 py-3 bg-primary rounded-none shadow-sm text-base text-white w-33"
        >
